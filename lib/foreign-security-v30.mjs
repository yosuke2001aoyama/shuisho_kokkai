...
const SOURCES = {
  usVisit: reference(
    'mofa-takaichi-us-visit-20260318',
    'fact',
    '高市内閣総理大臣の米国訪問',
    'https://www.mofa.go.jp/mofaj/na/na1/us/pageit_000001_02800.html',
    '外務省',
    '高市内閣総理大臣は、令和八年三月十八日から二十日まで米国を訪問し、ワシントンD.C.においてトランプ大統領との日米首脳会談等を実施する予定であり、二十一日に帰国する予定である。',
    '2026-03-18',
  ),
  alliance: reference(
    'mofa-us-faq',
...
export const FOREIGN_SECURITY_CASES = [
  entry(
    'japan-us-summit-visit-schedule',
    '外交・首脳外交',
    /(?:日米首脳会談.*(?:訪米|米国訪問)|(?:訪米|米国訪問).*日米首脳会談).*(?:予定|日程|時期|いかん)|(?:日米首脳会談及び.*訪米).*(?:予定|いかん)/u,
    '日米首脳会談及び高市総理の訪米の予定いかん。',
    [
      '政府が公表した日程では、高市総理は、令和八年三月十八日から二十日まで米国を訪問し、ワシントンD.C.においてトランプ大統領との日米首脳会談等を実施する予定である。',
      '十八日に東京を出発して同日ワシントンD.C.に到着し、二十日に同地を出発して二十一日に帰国する予定である。',
    ],
    [SOURCES.usVisit],
    /三月十八日から二十日.*日米首脳会談.*二十一日に帰国/us,
  ),
  ...
  entry('sofa-jurisdiction', '外交・日米地位協定', /(?:地位協定|在日米軍人).*(?:裁判権|刑事事件|身柄)|(?:裁判権|刑事事件|身柄).*在日米軍人/u, '在日米軍人の刑事事件では日本に裁判権がないのか。', ['在日米軍人の刑事事件について、我が国に裁判権がないということではない。', '日米地位協定は、公務執行中の作為又は不作為から生じた犯罪か否かなどに応じ、日米の第一次裁判権を区分している。'], [SOURCES.statusAgreement], /ないということではない.*第一次裁判権/u),
  ...
  entry(
    'china-diplomatic-firmness',
    '外交・中国',
    /(?:中国|対中).*(?:弱腰|及び腰|迎合|宥和|配慮しすぎ|遠慮しすぎ|譲歩しすぎ|甘すぎ|毅然と対応していない)|(?:弱腰|及び腰|迎合|宥和|甘すぎ).*中国/u,
    '我が国は中国に対して弱腰なのではないか。',
    [
      '御指摘は当たらない。',
      '政府は、中国との間で主張すべきは主張し、責任ある行動を強く求める一方、共通の課題では協力するとの一貫した方針の下、我が国の国益に基づき主体的に対応している。',
    ],
    [SOURCES.china],
    /御指摘は当たらない.*主張すべきは主張.*責任ある行動を強く求め.*主体的に対応/us,
  ),
  ...
  entry('senkaku-dispute', '外交・領土', /尖閣.*(?:領有権.*問題|問題.*存在|紛争|解決すべき)/u, '尖閣諸島をめぐる領有権問題は存在するのか。', ['尖閣諸島をめぐって解決しなければならない領有権の問題は、そもそも存在しない。', '尖閣諸島は我が国固有の領土であり、現に我が国が有効に支配している。'], [SOURCES.senkaku], /そもそも存在しない.*有効に支配/u),
  ...
  entry('japan-dprk-normalization', '外交・北朝鮮', /(?:日朝|北朝鮮).*(?:国交正常化|平壌宣言)/u, '政府は北朝鮮との国交正常化を目指しているのか。', ['政府は、日朝平壌宣言に基づき、拉致、核及びミサイルといった諸懸案を包括的に解決し、不幸な過去を清算して国交正常化を実現するとの方針である。'], [SOURCES.northKorea], /諸懸案を包括的に解決.*国交正常化/u),
  entry('takeshima', '外交・領土', /竹島.*(?:領土|領有権|不法占拠|基本的立場)/u, '竹島に関する日本政府の基本的立場は何か。', ['竹島は、歴史的事実に照らしても国際法上も明らかに我が国固有の領土である。', '韓国による竹島の占拠は国際法上何ら根拠のない不法占拠であり、政府は国際法にのっとり平和的に解決する方針である。'], [SOURCES.takeshima], /固有の領土.*不法占拠.*平和的/u),
  entry('korea-relations', '外交・韓国', /日韓関係|韓国.*(?:重要な隣国|パートナー|外交上の相手|位置付け)/u, '韓国を政府はどのような外交上の相手と位置付けているのか。', ['韓国は、国際社会の様々な課題への対応にパートナーとして協力すべき重要な隣国である。', '日韓関係を健全な形で発展させ、日韓米の戦略的連携を進めることは、地域の平和と安定に重要である。'], [SOURCES.korea], /重要な隣国.*日韓米/u),
  ...
  entry('northern-territories', '外交・領土', /北方領土|北方四島.*(?:領土|帰属|基本的立場)/u, '北方四島に関する政府の基本的立場は何か。', ['北方四島は、我が国が主権を有する島々である。', '政府は、北方四島の帰属の問題を解決して平和条約を締結するとの基本方針を堅持する。'], [SOURCES.northernTerritories], /主権を有する.*平和条約/u),
  ...
  entry('two-state-solution', '外交・中東', /二国家解決|イスラエル.*パレスチナ.*共存|中東和平.*(?:解決像|最終的な解決)/u, '中東和平に関する日本政府の最終的な解決像は何か。', ['我が国は、イスラエルと将来の独立したパレスチナ国家が平和かつ安全に共存する二国家解決を支持している。', '当事者間の交渉を通じた政治的解決に向け、信頼醸成及びパレスチナ支援に取り組む。'], [SOURCES.middleEast], /二国家解決.*政治的解決/u),
  ...
  entry('sdf-constitutionality', '防衛・憲法', /自衛隊.*(?:違憲|合憲|憲法上|憲法第?九条.*違反)|憲法第?九条.*自衛隊.*違反/u, '自衛隊は憲法第九条に違反するのか。', ['自衛隊は、憲法第九条に違反するものではない。', '憲法第九条の下でも、我が国が独立国として自国の平和と安全を維持し、存立を全うするために必要な自衛の措置を採ることは否定されず、自衛のための必要最小限度の実力を保持することは許される。'], [SOURCES.defensePolicy], /違反するものではない.*必要最小限度/u),
  ...
  entry('equipment-transfer', '防衛・装備移転', /防衛装備移転三原則|(?:防衛装備|武器).*(?:(?:輸出|移転).*(?:自由|無制限)|(?:自由|無制限).*(?:輸出|移転))|(?:自由|無制限).*(?:防衛装備|武器).*(?:輸出|移転)/u, '日本は防衛装備を自由に輸出できるのか。', ['我が国が防衛装備を自由に輸出することはできない。', '防衛装備移転三原則により移転を禁止する場合を明確にし、認め得る場合を限定して、厳格審査、情報公開及び目的外使用・第三国移転の適正管理を行う。'], [SOURCES.equipmentTransfer], /自由に.*できない.*厳格審査/u),
...
function matchPriority(entry, question) {
  if (entry.id === 'osa-purpose' && /(?:OSA|ＯＳＡ)/u.test(question)) return 100;
  if (entry.id === 'senkaku-dispute' && /領有権.*問題|問題.*存在|紛争/u.test(question)) return 100;
  return 0;
}
...
export function buildForeignSecurityAnswer(mode, question, respondent, version) {
  ...
  const matched = exact || FOREIGN_SECURITY_CASES
    .filter((item) => item.matcher.test(q))
    .sort((left, right) => matchPriority(right, q) - matchPriority(left, q))[0];
