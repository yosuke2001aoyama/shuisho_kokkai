...
const ABDUCTION_REFERENCE = {
  id: 'written:https://www.sangiin.go.jp/japanese/joho1/kousei/syuisyo/201/touh/t201002.htm',
  referenceKey: 'a1',
  sourceType: 'written',
  ...
  date: '2020-01-31',
  phrase: '政府は、認定の有無にかかわらず、全ての拉致被害者の安全確保及び即時帰国のために全力を尽くし、真相究明及び拉致実行犯の引渡しを引き続き追求する。',
  quotedPhrase: '政府は、認定の有無にかかわらず、全ての拉致被害者の安全確保及び即時帰国のために全力を尽くし、真相究明及び拉致実行犯の引渡しを引き続き追求する。',
  borrowed: false,
};
