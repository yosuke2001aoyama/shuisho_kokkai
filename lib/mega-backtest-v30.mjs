...
const QUESTION_VARIANTS = [
  ...
  (question) => `政府の見解を明確にされたい。${question}`,
];
...
export async function runMegaBacktests(caseId = '') {
  ...
  return {
    version: '32.0',
    methodology: {
      scope: '外交・安全保障66判断類型と、重複を除く外交・安全保障以外43制度類型を対象とする。',
      matrix: '各類型を三つの聞き方、総理・官房長官・大臣・政府参考人、国会口頭答弁・質問主意書答弁書の全組合せで試験する。',
      ...
      limitation: '試験は判断類型と聞き方の組合せを検証するもので、未知の質問は、一次資料による直接回答が成立しない限り公開を遮断する。',
    },
